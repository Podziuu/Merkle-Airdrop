...
TOKEN_ADDRESS=$(forge create src/StrenghToken.sol:StrenghToken --rpc-url http://127.0.0.1:8011 --private-key ${DEFAULT_ZKSYNC_LOCAL_KEY} --legacy --zksync | awk '/Deployed to:/ {print $3}' )
