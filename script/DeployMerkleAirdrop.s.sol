...
import {StrengthToken} from "../src/StrengthToken.sol"; 
...
contract DeployMerkleAirdrop is Script {
    ...
    function run() external returns (MerkleAirdrop, StrengthToken) {
        return deployMerkleAirdrop();
    }

    function deployMerkleAirdrop() public returns (MerkleAirdrop, StrengthToken) {
        vm.startBroadcast();
        StrengthToken token = new StrengthToken();
